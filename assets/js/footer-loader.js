                    ...
                    <div class="container mx-auto px-4 md:px-6">
                        <div class="flex flex-col md:flex-row items-center justify-between">
                            ...
                            <div class="flex flex-wrap justify-center gap-4 md:gap-6 text-sm text-dark/60">
                                <a href="/pages/terms-of-service/" class="hover:text-primary transition-colors">Terms</a>
                                <a href="/pages/privacy-policy/" class="hover:text-primary transition-colors">Privacy</a>
                                <a href="/pages/report-problem/" class="hover:text-primary transition-colors">Support</a>
                            </div>
